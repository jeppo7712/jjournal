...
async function connectDatabase(databaseUrl, broadcastStatus, uuidv4) {
  try {
    ...
    // securities are traded. Added for tracking US-situs estate tax
    // exposure (cash at a US entity like IBKR LLC counts toward the
    // combined-$60k threshold for a non-US person; cash at a non-US entity
    // doesn't). custodian is free text for a human to read (e.g. "IBKR
